...
- nas abas Projetos, Tarefas e Reuniões, a busca sem termo mostra apenas
  resultados contextuais; ao digitar, a pesquisa se amplia para destinos
  visíveis, mantendo os resultados relacionados primeiro;
- nas abas Tarefas e Reuniões, os resultados “Em andamento” aparecem antes dos
