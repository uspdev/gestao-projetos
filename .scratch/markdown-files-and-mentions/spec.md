...
- Manter JavaScript e CSS próprios em `resources/` e copiá-los sem transformação para `public/` pelo comando `php artisan projetos:assets-publish`. Usar módulos ES nativos no navegador e folhas CSS vinculadas diretamente, sem depender de npm, Laravel Mix, Webpack ou PostCSS.
