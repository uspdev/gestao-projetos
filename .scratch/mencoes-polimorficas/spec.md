...
- **Autocomplete:** `@` abre um seletor unificado, inicialmente em **Todos**, com filtros para Pessoas, Projetos, Tarefas, Reuniões e Arquivos. Resultados mostram seu tipo durante a escolha e nunca exigem identificadores do autor.
- **Prioridade contextual:** resultados do contexto natural vêm primeiro. Projeto, Tarefa e Reunião podem ampliar a busca para outros destinos visíveis; Usuários e Arquivos permanecem contextuais. Comentário herda seu objeto.
