...
- **Autocomplete:** `@` abre um seletor unificado, inicialmente em **Usuários**, com filtros para Usuários, Projetos, Tarefas, Reuniões e Arquivos. Cada filtro mostra somente o nome ou título; a caixa mantém largura fixa e rótulos visíveis são truncados com reticências. Resultados nunca exigem identificadores do autor.
- **Prioridade contextual:** resultados do contexto natural vêm primeiro. Na aba Projetos, sem termo, aparecem apenas os Projetos contextuais e uma orientação para digitar; com termo, a busca se amplia para todos os Projetos visíveis ao autor, separando Projetos relacionados de outros Projetos acessíveis. Projeto, Tarefa e Reunião podem ampliar a busca para outros destinos visíveis; Usuários e Arquivos permanecem contextuais. Comentário herda seu objeto.
